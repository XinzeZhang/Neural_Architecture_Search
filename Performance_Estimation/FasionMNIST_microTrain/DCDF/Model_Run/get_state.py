...
if __name__ == '__main__':
    ...
    model_name=str(aT_model.__class__.__name__)+"_C"+str(args.conv1_size)+"C"+str(args.conv2_size)+"F"+str(args.fc1_size)+"F10"
    ...
    if args.k_allTrain_epochs == args.total_epochs:
        ...
        print("Error ! please make sure k_allTrain is equal to totals!")
        exit()
